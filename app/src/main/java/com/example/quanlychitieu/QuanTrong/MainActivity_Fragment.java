...
import com.example.quanlychitieu.DAO.ProFile_Fragment;
...
public class MainActivity_Fragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Add();
        Toast.makeText(MainActivity_Fragment.this,"Đăng nhập thành công", Toast.LENGTH_LONG).show();
        ...
        chipNavigationBar.setOnItemSelectedListener(new ChipNavigationBar.OnItemSelectedListener() {
            ...
            public void onItemSelected(int i) {
                ...
                switch (i) {
                    ...
                    case R.id.btn_nav_LoaiCT:{
                        fragment=new QuanLyTongThe();
                        break;
                    }
                }
                if(co==0){
